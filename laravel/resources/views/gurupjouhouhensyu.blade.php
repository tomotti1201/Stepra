        ...
        <div class="card shadow p-3 bg-body-tertiary">
          ...
          <div class="row g-2 mb-3 align-items-center">
            ...
            <div class="col-12 col-md-3">
              <button class="btn btn-outline-secondary w-100 py-2">招待ID</button>
            </div>
          </div>
          ...
          <div class="row g-2 mb-3">
            <div class="col-12 col-md-6">
              <button class="btn btn-primary w-100 py-3 fw-bold">グループの編集</button>
            </div>
            <div class="col-12 col-md-6">
              <button class="btn btn-success w-100 py-3 fw-bold">グループタスクの追加・編集</button>
            </div>
          </div>

          <div class="text-center">
            <button class="btn btn-secondary w-100 py-2 fw-bold">管理者モード切り替え</button>
          </div>
