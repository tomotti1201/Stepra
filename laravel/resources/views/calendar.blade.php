...
function clickDate(date) {
  ...
  // 例: 日付を押したら「kiroku.html」に遷移する（URLの後ろに選んだ年月日をくっつけて送る設定）
  // パラメータが不要でただページを飛ばしたい場合は window.location.href = "kiroku.html"; だけでも動きます
  window.location.href = `kiroku.html?year=${year}&month=${month}&day=${date}`;
}
